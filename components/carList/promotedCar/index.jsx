    ...
    <div className={styles.PromotedCar}>
      <div className={styles.PromotedCarImageContainer}>
        ...
        <div className={styles.cardStatusContainer}>
          <div className={`${styles.cardStatus} bg-red-450`}>Promoted</div>
          <div className={`${styles.cardStatus} bg-blue-270`}>Negotiable</div>
        </div>
      </div>
      ...
      <h1 className={`featured-title-02 ${styles.carName}`}>
